...
def profile():
    """Profile page where users can enter email to view their bookings"""
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            flash('No bookings found for this email address. Please check your email or make a booking first.', 'info')
